...
API.onEntityDataChange.connect(function (player, data, oldValue) {
    ...
    if (API.getEntityType(player) !== 6 /* Player */) {
        return;
    }
...
class Mission {
    ...
    setupMarker() {
        ...
        switch (this.missionType) {
            case "Location":
                missionMarker = API.createMarker(1 /* VerticalCylinder */, this.Location, new Vector3(), new Vector3(), new Vector3(3, 3, 3), markerR, markerG, markerB, markerAlpha);
                break;
            case "Capture":
                missionMarker = API.createMarker(1 /* VerticalCylinder */, this.Location, new Vector3(), new Vector3(), new Vector3(5, 5, 5), markerR, markerG, markerB, markerAlpha);
                break;
            case "FastCapture":
                missionMarker = API.createMarker(1 /* VerticalCylinder */, this.Location, new Vector3(), new Vector3(), new Vector3(5, 5, 5), markerR, markerG, markerB, markerAlpha);
                break;
