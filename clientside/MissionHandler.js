...
function setupMarkers() {
    ...
    for (var i = 0; i < objectiveLocations.length; i++) {
        ...
        switch (objectiveTypes[i]) {
            case "Location":
                newMarker = API.createMarker(20 /* ChevronUpX1 */, objectiveLocations[i].Add(new Vector3(0, 0, 2)), new Vector3(), new Vector3(), new Vector3(1, 1, 1), markerRGBA[0], markerRGBA[1], markerRGBA[2], markerRGBA[3]);
                break;
            case "Capture":
                newMarker = API.createMarker(1 /* VerticalCylinder */, objectiveLocations[i], new Vector3(), new Vector3(), new Vector3(5, 5, 5), markerRGBA[0], markerRGBA[1], markerRGBA[2], markerRGBA[3]);
                break;
            case "FastCapture":
                newMarker = API.createMarker(1 /* VerticalCylinder */, objectiveLocations[i], new Vector3(), new Vector3(), new Vector3(5, 5, 5), markerRGBA[0], markerRGBA[1], markerRGBA[2], markerRGBA[3]);
                break;
...
class ObjectiveProgression {
    ...
    get ObjectiveLocation() {
        return this.objectiveLocation;
    }
    set ObjectiveProgress(value) {
